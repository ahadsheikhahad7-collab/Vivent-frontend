...
import { loadJoinedEvents, saveJoinedEvent } from "../utils/joinedEvents";
...
const Educationalexpo = () => {
  ...
  const [customExpoEvents, setCustomExpoEvents] = useState([]);
  ...
  useEffect(() => {
    const refreshJoinedEvents = () => {
      const joinedIds = loadJoinedEvents()
        .filter(
          (entry) =>
            entry.type === "Educational Expo" &&
            entry.eventKey?.startsWith("educational-expo-")
        )
        .map((entry) => entry.eventKey.replace("educational-expo-", ""));
  ...
  useEffect(() => {
    const refreshCreatedEvents = () => {
      setCustomExpoEvents(loadCreatedEventsByCategory("educational-expo"));
    };
  ...
  const submitExpoJoin = (event) => {
    event.preventDefault();

    if (!selectedEvent) return;

    saveJoinedEvent({
      eventKey: `educational-expo-${selectedEvent.id}`,
      type: "Educational Expo",
      ...
      educationLevel: joinForm.educationLevel,
      programInterest: joinForm.programInterest,
      preferredDestination: joinForm.preferredDestination,
    ...
    <div className="bg-gray-100">
      ...
      <section className="py-20">
        ...
        <div className="mx-auto max-w-5xl space-y-5 px-6">
          {[...customExpoEvents, ...showcaseEvents.educationalExpo].map((item) => (
            <article
                ...
                <div className="w-full p-5 lg:w-[65%] lg:p-7">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      ...
                      type="button"
                    >
                      {joinedEventIds.includes(item.id) ? "Joined" : "Join Expo"}
                    </button>
                    <button
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              <label className="block text-sm font-bold text-blue-800">
                ...
                <input
                  ...
                  placeholder="College, university or academy"
              ...
              <label className="block text-sm font-bold text-blue-800">
                ...
                <input
                  ...
                  placeholder="Intermediate, BS, Masters..."
                  value={joinForm.educationLevel}
                />
              </label>
              ...
              <label className="block text-sm font-bold text-blue-800">
                ...
                <input
                  ...
                  placeholder="Business, tech, study abroad..."
                  value={joinForm.programInterest}
                />
              </label>
              ...
              <label className="block text-sm font-bold text-blue-800">
                ...
                <input
                  ...
                  placeholder="Pakistan, UK, Canada..."
                  value={joinForm.preferredDestination}
                />
              </label>
