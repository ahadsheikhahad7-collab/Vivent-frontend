      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-200">
            Explore premium food festivals, cultural cuisines, chef experiences,
            and exciting dining events organized through the VIVENT platform.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="mb-14 px-6 text-center">
          ...
          <p className="mx-auto max-w-2xl leading-relaxed text-gray-600">
            Experience delicious cuisines, live cooking sessions, and premium
            dining festivals through our modern event platform.
          </p>
        </div>
